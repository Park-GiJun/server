package kr.hhplus.be.server.application.handler.query.concert
...
class ConcertQueryHandler(
    ...
    private val log = LoggerFactory.getLogger(ConcertQueryHandler::class.java)
    ...
    override fun getPopularConcert(limit: Int): List<PopularConcertResult> {
        ...
        return try {
            ...
            if (cachedValue != null) {
                ...
                cachedValue as List<PopularConcertResult>
            } else {
    ...
    override fun getHotConcert(limit: Int): List<PopularConcertResult> {
        return try {
    ...
    private fun fetchPopularConcertsFromDB(limit: Int): List<PopularConcertResult> {
        return try {
    ...
    private fun fetchHotConcertsFromRedis(limit: Int): List<PopularConcertResult> {
